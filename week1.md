...
The aim of this week was to plan the operating system deployment, select a suitable Linux server distribution, and set up the basic virtual place required for the coursework. A dual-system architecture was designed to reflect real-world professional practice where system administration is carried out casually.

---

## 2. System Architecture Overview

This coursework uses a dual-system architecture existing:
...
The workstation privately connects to the server through a private virtual network. All administration of the server is performed casually from the workstation.
...
Evidence of these commands is provided below:
...
In this week we are mainly focused on system planning, operating system selection, workstation design, and initial Ubuntu Server deployment. I learned how to install a headless Linux server, configure virtual networking, and use fundamental Linux commands to review system hardware and software information. This week provided a strong technical foundation for the security configuration analysis that will be focused on later weeks.
